...
public class CounterSupervisorActor extends AbstractActor {
    ...
    private static SupervisorStrategy strategy =
        new OneForOneStrategy(
            1, // Max no of retries (i.e. failures to be tolerated in the time period of next line)
            Duration.ofMinutes(1), // Within what time period
            DeciderBuilder.match(Exception.class, e -> SupervisorStrategy.restart()) //alternatives: resume(), stop()
                .build());

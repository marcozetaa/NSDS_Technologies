...
public class Counter {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < numMessages; i++) {
			exec.submit(() -> counter.tell(new SimpleMessage(SimpleMessage.DECREMENT), ActorRef.noSender()));
			exec.submit(() -> counter.tell(new SimpleMessage(SimpleMessage.INCREMENT), ActorRef.noSender()));
		}

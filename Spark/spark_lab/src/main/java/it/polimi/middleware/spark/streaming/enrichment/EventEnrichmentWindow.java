 ...
 */
public class EventEnrichmentWindow {
    public static void main(String[] args) throws TimeoutException {
        ...
        // Query: count the number of products of each class in the stream in a window
